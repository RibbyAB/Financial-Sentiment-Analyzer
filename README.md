...
The user enters an Indonesian financial news headline.

The text is cleaned and normalized before inference.

The user selects one of the available NLP models.

The selected model predicts one of three sentiment classes: Negative, Neutral, or Positive.

The application displays the predicted sentiment and confidence score when available.
...
Enter an Indonesian financial news headline in the text box.

Select IndoDistilBERT, IndoBERT, SVM, or Random Forest.

Click Jalankan Analisis.

View the predicted sentiment and model confidence.
